...
\begin{center}
 \begin{tabular}{l|l|l}
  ...
  $AB \rightarrow D$ & $AB \rightarrow D$ & $AB \rightarrow D$\\
 ...
 \end{tabular}
\end{center}
Quindi si esegue l'algoritmo 4.5 ed esce $\rho= \{I, ABD, BE, EA, EC, HB\}$.
...
\subsection{Esame 10/09/2013}
 ...
 (2) $\pi_{B,C}((\sigma_{D=``Roma''}(MUSEO))\bowtie_{A=N}((\sigma_{H!=``Caravaggio''}(PITTORE))\bowtie_{E=M}(QUADRO)))$\\
...
\noindent\textbf{\fontsize{14pt}{1em}Soluzione.}\\
Bisogna distribuire uniformemente i record nei bucket. Ogni bucket contiene
%%%%DA FINIRE%%%
\begin{center}
 $\Bigl\lfloor \dfrac{1.750.000}{300} \Bigr\rfloor = 5.833$ record.\\
\end{center}
