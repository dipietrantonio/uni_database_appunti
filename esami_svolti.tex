...
\bigr\rceil = 5$).\\
 ...
 \end{itemize}
  ...
  \end{center}
  Se si tratta di un B-tree, al valore ottenuto dalla formula bisogna aggiungere +1. Esso rappresenta quel record in più che 
  contiene il puntatore al blocco contentente record che hanno chiave minore della sua chiave più piccola. \`E da tenere a mente 
...
\subsection{Esame 12/11/2013}
 ...
 $B \rightarrow E$ & $B \rightarrow E$ & $D \rightarrow E$\\
 $E \rightarrow D$ & $E \rightarrow D$ & $E \rightarrow D$\\
 \end{tabular}\\
 
 \noindent Applicando l'Algoritmo 4.5 troviamo $\rho^1= \{H, ABC, DE\}$, alla quale aggiungiamo la chiave di $R$
