...
\begin{multicols}{2}
 \includegraphics[width=170px]{immagini-eps/grafo1.eps}\\
 \includegraphics[width=170px]{immagini-eps/grafo2.eps}
\end{multicols}
...
\begin{center}
\includegraphics[width=200px]{immagini-eps/ordinamento_topologico.eps}\\ 
\end{center}
...
\begin{center}
  \includegraphics[width=150px]{immagini-eps/img_6_3_1.eps}
\end{center}
...
\begin{center}
 \includegraphics[width=150px]{immagini-eps/grafo3.eps}
\end{center}
...
\begin{center}
 \includegraphics[width=150px]{immagini-eps/img_6_3_2.eps}
\end{center}
contiene un ciclo.\\
...
\hline
 \end{longtable}
\end{center}
Le figure prime tre seguenti mostrano il poligrafo che viene costruito ai passi 1, 2 e 3 dell'algoritmo.
\begin{multicols}{2}

\includegraphics[width=180px]{immagini-eps/img_6_3_2(1).eps}\\
Passo 1

\includegraphics[width=180px]{immagini-eps/img_6_3_2(3).eps}\\
Passo 3

\includegraphics[width=180px]{immagini-eps/img_6_3_2(2).eps}\\
Passo 2

\includegraphics[width=150px]{immagini-eps/img_6_3_2(4).eps}\\
